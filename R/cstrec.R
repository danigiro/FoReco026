...
#' \code{\link[FoReco026]{tcsrec}()}), is inverted. The function
#' \code{\link[FoReco026]{cstrec}()} performs cross-sectional reconciliation
#' (\code{\link[FoReco026]{htsrec}()}) first, then temporal reconciliation
#' (\code{\link[FoReco026]{thfrec}()}), and finally applies the average of the
