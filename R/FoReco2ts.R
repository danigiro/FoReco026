...
#'
#' @param recf (\mjseqn{h(k^\ast + m) \times 1}) forecasts vector from \link[FoReco026]{thfrec},
#' (\mjseqn{h \times n}) forecasts matrix from \link[FoReco026]{htsrec} or
#' (\mjseqn{n \times h(k^\ast + m)}) forecasts matrix from \link[FoReco026]{octrec},
#' \link[FoReco026]{tcsrec}, \link[FoReco026]{cstrec}, \link[FoReco026]{iterec},
#' \link[FoReco026]{ctbu}.
...
#'
#' @return
#' A list of class \code{"ts"} objects for \link[FoReco026]{FoReco2ts} and a list of
#' matrix/vector for \link[FoReco026]{FoReco2matrix}
#'
#' @examples
#' data(FoReco_data)
