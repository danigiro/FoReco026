...
**Warning: This package version is no longer supported. Please upgrade to FoReco 1.0, which includes significant changes and is not compatible with previous versions.**

The **FoReco** (**Fo**recast **Reco**nciliation) package is designed for forecast reconciliation, a **post-forecasting** process aimed to improve the accuracy of the base forecasts for a system of linearly constrained (e.g. hierarchical/grouped) time series.
...
You can also install from [Github](https://github.com/daniGiro/FoReco026)
...
If you encounter a clear bug, please file a minimal reproducible example on [GitHub](https://github.com/daniGiro/FoReco026/issues).
